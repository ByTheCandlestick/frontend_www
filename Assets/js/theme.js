	...
	product = {
		save: function(pid) {
			...
			data = {
				...
				'container': $("div[name=container]").find("input").val(),
				'wick': $("div[name=wick]").find("input").val(),
				'wick_stand': $("div[name=wick_stand]").find("input").val(),
				'material': $("div[name=material]").find("input").val(),
				'fragrance': $("div[name=fragrance]").find("input").val(),
				'colour': $("div[name=colour]").find("input").val(),
				'packaging': $("div[name=packaging]").find("input").val(),
				'shipping': $("div[name=shipping]").find("input").val(),
				'made_by': $("div[name=made_by]").find("input").val(),
