						...
						// Confirm and upload the transaction info to the DB
							if ($chargeJson['amount_refunded'] == 0 && empty($chargeJson['failure_code']) && $chargeJson['paid'] == 1 && $chargeJson['captured'] == 1) {
								...
								// Save Order
									...
									$mdl_stripe->uploadSalesOrder($invoice_number, $uid, $name, $email, $phone, $items, $notes, $shipping = 1, $address_id, $price, $chargeJson['amount'], $chargeJson['application_fee_amount'], $chargeJson['currency'], $status = 1, $chargeJson['balance_transaction'], $chargeJson['id'], $chargeJson['status'], $chargeJson['payment_method_details']['card']['network'], $chargeJson['payment_method_details']['card']['last4'], $chargeJson['payment_method_details']['card']['exp_month'], $chargeJson['payment_method_details']['card']['exp_year']);
