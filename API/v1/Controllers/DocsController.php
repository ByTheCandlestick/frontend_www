				...
				elseif(strtoupper($requestMethod) == "GET"):	// (R)EAD	-- 🗷 --	Get the users invoice
					...
					// Submit application
						try{
							...
							$curr = iconv('UTF-8', 'cp1252//IGNORE', CurrencySymbolUtil::getSymbol(strtoupper($invoice['Currency'])));
							...
							// Header
								...
								// Divider
									$pdf->Line(5, 37, $pdf->GetPageWidth()-5, 37);
							// Content
								$pdf->SetTextColor(28, 92, 147);
								// Invoice Date / ID
