	...
	class ConfigModel extends BaseModel {
		 ...
		 */
            public function updatePermission(string $oldName, string $newName, string $default, string $uid) {
				$this->uploadAudit(__FUNCTION__, array($oldName, $newName, $default), "Updated a permission", "Permissions", $uid);
		 ...
		 */
			public function deletePermission(string $name, string $uid) {
				$this->uploadAudit(__FUNCTION__, array($name), "Deleted a permission", "Permissions", $uid);
