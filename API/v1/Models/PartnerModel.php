	...
	class PartnerModel extends BaseModel {
         ...
         */
			public function Create(string $name, string $public, string $desc_s, string $desc_l, string $logo, string $link, string $email, string $phone, string $slug, string $active, string $uid) {
				$vars = array(array('name', $name), array('public', $public), array('desc_s', $desc_s), array('desc_l', $desc_l), array('logo', $logo), array('link', $link), array('email', $email), array('phone', $phone), array('slug', $slug), array('active', $active), array('uid', $uid));
				$this->uploadAudit(__FUNCTION__, $vars, "Created a new partner", "Partners", $uid);
				try {
					// Add line to Partner
         ...
         */
			public function Update(string $id, string $name, string $public, string $desc_s, string $desc_l, string $logo, string $link, string $email, string $phone, string $slug, string $active, string $uid) {
				$vars = array(array('id', $id), array('name', $name), array('public', $public), array('desc_s', $desc_s), array('desc_l', $desc_l), array('logo', $logo), array('link', $link), array('email', $email), array('phone', $phone), array('slug', $slug), array('active', $active), array('uid', $uid));
				$this->uploadAudit(__FUNCTION__, $vars, "Updated a Partner", "Partners", $uid);
				try {
         ...
         */
			public function Delete(string $id, string $uid) {
				try {
					...
					$this->uploadAudit(__FUNCTION__, $vars, "Deleted a partner", "Partners", $uid);
					// Update Partners line
