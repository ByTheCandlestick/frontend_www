<?
	class WebsiteModel extends BaseModel {
		 ...
		 *	@result boolean
		 */
			public function CreateWebsite(array $info, string $uid) {
		 ...
		 *	@result boolean
		 */
			public function UpdateWebsite(string $sid, array $info, string $uid) {
		 ...
		 *	@result boolean
		 */
			public function DeleteWebsite(string $sid, string $uid) {
		 ...
		 *	@result boolean
		 */
			public function CreateStyle(array $info, string $uid) {
				$vars = array(array('info', $info), array('uid', $uid));
		 ...
		 *	@result boolean
		 */
			public function UpdateStyle(string $id, array $info, string $uid) {
		 ...
		 *	@result boolean
		 */
			public function DeleteStyle(string $id, string $uid) {
		 ...
		 *	@result boolean
		 */
			public function CreateScript(array $info, string $uid) {
				$vars = array(array('info', $info), array('uid', $uid));
		 ...
		 *	@result boolean
		 */
			public function UpdateScript(string $id, array $info, string $uid) {
				$vars = array(array('id', $id), array('info', $info), array('uid', $uid));
		 ...
		 *	@result boolean
		 */
			public function DeleteScript(string $id, string $uid) {
				$vars = array(array('id', $id), array('uid', $uid));
		 ...
		 *	@result boolean
		 */
			public function CreateTheme(array $info, string $uid) {
				$vars = array(array('info', $info), array('uid', $uid));
		 ...
		 *	@result boolean
		 */
			public function UpdateTheme(string $id, array $info, string $uid) {
				$vars = array(array('id', $id), array('info', $info), array('uid', $uid));
		 ...
		 *	@result boolean
		 */
			public function DeleteTheme(string $id, string $uid) {
				$vars = array(array('id', $id), array('uid', $uid));
