	...
	class WebsiteModel extends BaseModel {
		 ...
		 */
			public function CreateWebsite(array $info) {
				$this->uploadAudit(__FUNCTION__, (new ReflectionFunction(__FUNCTION__))->getParameters(), "Created a new Website/Domain", "Website", $info['uid']);
		 ...
		 */
			public function UpdateWebsite(string $sid, array $info) {
				$this->uploadAudit(__FUNCTION__, (new ReflectionFunction(__FUNCTION__))->getParameters(), "Updated a Website/Domain", "Website", $info['uid']);
		 ...
		 */
			public function DeleteWebsite(string $sid) {
				$this->uploadAudit(__FUNCTION__, (new ReflectionFunction(__FUNCTION__))->getParameters(), "Deleted a Website/Domain", "Website", "");
		 ...
		 */
			public function CreateStyle(array $info) {
				$this->uploadAudit(__FUNCTION__, (new ReflectionFunction(__FUNCTION__))->getParameters(), "Created a new CSS style link", "CSS", $info['uid']);
		 ...
		 */
			public function UpdateStyle(string $id, array $info) {
				$this->uploadAudit(__FUNCTION__, (new ReflectionFunction(__FUNCTION__))->getParameters(), "Updated a CSS style link", "CSS", $info['uid']);
		 ...
		 */
			public function DeleteStyle(string $id) {
				$this->uploadAudit(__FUNCTION__, (new ReflectionFunction(__FUNCTION__))->getParameters(), "Deleted a CSS style link", "CSS", "");
		 ...
		 */
			public function CreateScript(array $info) {
				$this->uploadAudit(__FUNCTION__, (new ReflectionFunction(__FUNCTION__))->getParameters(), "Created a new JS script link", "JS", $info['uid']);
		 ...
		 */
			public function UpdateScript(string $id, array $info) {
				$this->uploadAudit(__FUNCTION__, (new ReflectionFunction(__FUNCTION__))->getParameters(), "Updated a JS script link", "JS", $info['uid']);
		 ...
		 */
			public function DeleteScript(string $id) {
				...
				$this->uploadAudit(__FUNCTION__, (new ReflectionFunction(__FUNCTION__))->getParameters(), "Deleted a JS script link", "JS", "");
		 ...
		 */
			public function CreateTheme(array $info) {
				$this->uploadAudit(__FUNCTION__, (new ReflectionFunction(__FUNCTION__))->getParameters(), "Created a new Theme", "Theme", $info['uid']);
		 ...
		 */
			public function UpdateTheme(string $id, array $info) {
				$this->uploadAudit(__FUNCTION__, (new ReflectionFunction(__FUNCTION__))->getParameters(), "Updated a Theme", "Theme", $info['uid']);
		 ...
		 */
			public function DeleteTheme(string $id) {
				$this->uploadAudit(__FUNCTION__, (new ReflectionFunction(__FUNCTION__))->getParameters(), "Deleted a Theme", "Theme", "");
