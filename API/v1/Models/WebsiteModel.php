	...
	class WebsiteModel extends BaseModel {
		 ...
		 */
			public function CreateWebsite(array $info) {
				$this->uploadAudit(__FUNCTION__, func_get_args(), "Created a new Website/Domain", $info['uid']);
		 ...
		 */
			public function UpdateWebsite(string $sid, array $info) {
				$this->uploadAudit(__FUNCTION__, func_get_args(), "Updated a Website/Domain", $info['uid']);
		 ...
		 */
			public function DeleteWebsite(string $sid) {
				$this->uploadAudit(__FUNCTION__, func_get_args(), "Deleted a Website/Domain", "");
		 ...
		 */
			public function CreateStyle(array $info) {
				$this->uploadAudit(__FUNCTION__, func_get_args(), "Created a new CSS style link", $info['uid']);
		 ...
		 */
			public function UpdateStyle(string $id, array $info) {
				$this->uploadAudit(__FUNCTION__, func_get_args(), "Updated a CSS style link", $info['uid']);
		 ...
		 */
			public function DeleteStyle(string $id) {
				$this->uploadAudit(__FUNCTION__, func_get_args(), "Deleted a CSS style link", "");
		 ...
		 */
			public function CreateScript(array $info) {
				$this->uploadAudit(__FUNCTION__, func_get_args(), "Created a new JS script link", $info['uid']);
		 ...
		 */
			public function UpdateScript(string $id, array $info) {
				$this->uploadAudit(__FUNCTION__, func_get_args(), "Updated a JS script link", $info['uid']);
		 ...
		 */
			public function DeleteScript(string $id) {
				$this->uploadAudit(__FUNCTION__, func_get_args(), "Deleted a JS script link", "");
		 ...
		 */
			public function CreateTheme(array $info) {
				$this->uploadAudit(__FUNCTION__, func_get_args(), "Created a new Theme", $info['uid']);
		 ...
		 */
			public function UpdateTheme(string $id, array $info) {
				$this->uploadAudit(__FUNCTION__, func_get_args(), "Updated a Theme", $info['uid']);
		 ...
		 */
			public function DeleteTheme(string $id) {
				$this->uploadAudit(__FUNCTION__, func_get_args(), "Deleted a Theme", "");
