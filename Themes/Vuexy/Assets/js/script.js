...
$(document).ready(function() {
	...
	$('.zoho-status.error').click(()=>{
		// Request auth	code
		$.ajax({
			url: 'https://accounts.zoho.eu/oauth/v2/auth?scope=ZohoMail.messages.ALL,ZohoMail.attachments.ALL,ZohoMail.tags.ALL,ZohoMail.folders.ALL&client_id='+$('.zoho-status').attr('cid')+'&response_type=code&access_type=offline&redirect_uri=http://admin.candlestick-indev.co.uk/OauthCallback.php',
