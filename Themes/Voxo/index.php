<?
	...
	// Determine the required row from the page requested
		$domainID = domainID();
		if(QS_SUBPAGE != NULL) {
			$query = sprintf("SELECT * FROM `Website pages`  WHERE `page_url`='%s' AND `subpage_url`='%s' AND `domain_id`='%s' LIMIT 1", QS_PAGE, QS_SUBPAGE, $domainID);
			try {
	...
	<html lang="en">
		<head runat="server">
			...
			<!-- ===== CSS ===== -->
				...
				<style>
					@import url('https://fonts.googleapis.com/css?family=Share+Tech+Mono|Open+Sans:300,300i,400,400i,600,600i,700,700i|Raleway:300,300i,400,400i,600,600i,700,700i,900|Montserrat:100,300,400|Josefin+Sans:300,400,700&display=swap');

					@import url('/parts/app-colours.css');
					@import url('/parts/general.css');
					@import url('/parts/custom-bootstrap.css');
					@import url('/parts/about-list.css');
					@import url('/parts/about.css');
					@import url('/parts/app-back-to-top.css');
					@import url('/parts/boutique.css');
					@import url('/parts/breadcrumbs.css');
					@import url('/parts/checkout.css');
					@import url('/parts/contact-us.css');
					@import url('/parts/counts.css');
					@import url('/parts/faq.css');
					@import url('/parts/footer.css');
					@import url('/parts/forms.css');
					@import url('/parts/app-gdpr.css');
					@import url('/parts/app-header.css');
					@import url('/parts/hero-carousel.css');
					@import url('/parts/hero-jumbotron.css');
					@import url('/parts/portfolio-details.css');
					@import url('/parts/portfolio.css');
					@import url('/parts/app-preloader.css');
					@import url('/parts/product.css');
					@import url('/parts/section.css');
					@import url('/parts/services.css');
					@import url('/parts/team.css');
					@import url('/parts/app-topbar.css');
				</style>
			<!-- ===== EOS ===== -->
		</head>
			...
			<!-- ===== redirect tags ===== -->
					<?
						if(isset($_GET['rw']) && $_GET['rw'] != "") {
							print('
								<rw data="' . mysqli_fetch_row(DB_QUERY(sprintf("SELECT `Domain` FROM `Website domains` WHERE `ID`='%s'", $_GET['rw'])))[0] . '"></rw>
							');
						}
				...
				<header id="header" class="d-flex align-items-center">
					<div class="container d-flex align-items-center">
						<div class="logo me-auto d-flex">
						  ...
						  <h1 class="d-none d-md-block"><a href="/"><?=($website_info['Title'])?></a></h1>
					  </div>
							...
							<div class="footer-cols">
								<div class="text-center footer-col-4 footer-links">
									...
									<ul class="d-inline-block">
										...
										<li><i class="fad fa-link pe-1"></i> <a href="<?=(URL_BLOG)?>">Blog</a></li>
									...
									?>
										...
										?>
											...
											?>
												<li>
													<i class="fad fa-pencil pe-1"></i>
													<a href="<?=(URL_ADMIN.'/Partners/Edit/'.$partner['ID'].'/?force_back=1')?>">Edit this partner</a>
												</li>
											<?
												}
											...
											?>
												<li>
													<i class="fad fa-pencil pe-1"></i>
													<a href="<?=(URL_ADMIN.'/Blog/Edit/'.$blog['ID'].'/?force_back=1')?>">Edit this blog post</a>
												</li>
											<?
												}
											}
										...
										<li>
											...
											<a onclick="account.logout('<?=($_COOKIE['session_code'])?>')">Logout</a>
										</li>
									<?
										} else {
									?>
								...
								<div class="text-center footer-col-5 footer-links">
									...
									<ul class="d-inline-block">
										...
										<div class="trustpilot-widget" style="position: relative; padding-top: 1em; display: inline-block;" data-locale="en-GB" data-template-id="5419b6a8b0d04a076446a9ad" data-businessunit-id="63e147d32ba9106ee583df67" data-style-height="40px" data-style-width="100%" data-theme="dark" data-min-review-count="10" data-without-reviews-preferred-string-id="1" data-style-alignment="center">
