				...
				<div class="row col s12">
					...
					<div class="row">
						...
						<div class="mb-3 px-2 col-12 col-lg-4">
							<input type="submit" name="lookup" class="btn btn-secondary-outline h-100 w-100" value="Lookup" onClick="address.lookup()">
						</div>
						<div class="mb-3 px-2 col-12 col-lg-4">
							<input type="submit" name="manual" class="btn btn-primary h-100 w-100" value="Enter manually" onClick="address.enterManual()">
						</div>
					</div>
					<div class="row">
						<div class="form-floating mb-3 px-2 col-12 col-lg-4">
