		...
		<div class="mb-3 px-3 px-lg-3 col-lg-10">
			...
			<?if (DB_Query(sprintf("SELECT * FROM `User addresses` WHERE `uid`='%s'", $userdate['ID']))) { ?>
					...
					<div class="form-floating py-1">
						...
						<?
							...
							foreach($items as $item) {
								...
								print(sprintf('
									<option fname="%s" lname="%s" number_name="%s" line1="%s" line2="%s" town="%s" county="%s" country="%s" postcode="%s" phone="%s" value="%s">%s</option>
								', $item['firstname'], $item['lastname'], $item['number_name'], $item['line_1'], $item['line_2'], $item['town'], $item['county'], $item['country'], $item['postcode'], $item['phone'], $value, $name));
							}
						?>
						</select>
					</div>
				...
				<div class="row newAddress-billing d-none">
					<div class="form-floating my-3 pe-1 col-12 col-lg-6">
					...
					<div class="form-floating my-3 ps-1 col-12 col-lg-6">
					...
					<div class="form-floating mb-3 pe-1 col-12 col-lg-7">
					...
					<div class="form-floating mb-3 ps-1 col-12 col-lg-5">
						<input type="text" name="postcode" class="form-control" id="floatingInput-postcode" autocomplete="postal-code" onKeyUp="address.lookup(this)" required>
					...
					<div class="form-floating mb-3 pe-1 col-12 col-lg-6">
					...
					<div class="form-floating mb-3 ps-1 col-12 col-lg-6">
