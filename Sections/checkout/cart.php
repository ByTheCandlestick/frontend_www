		...
		if($cart_items != null) {
			...
			for($i=0;$i<$cart_items_count;$i++) {
				...
				if($q = DB_Query("SELECT * FROM `Product` WHERE `SKU`=$cart_item_id AND `Active`=1 LIMIT 1")) {
					...
					print('
						<cart-item prod-sku="'.$cart_item_id.'" prod-qty="'.$cart_item_quantity.'" prod-opt="'.$cart_items[$i][4].'">
								...
								<div class="row col-12 col-lg-8 pb-2 pb-lg-0">
									...
									<div class="col-9 col-md-8 align-items-center">
										<div class="top-50 position-relative" style="transform:translatey(-50%);">
											<p>
												<a class="link-dark" href="/Boutique/product/'.$cart_item_slug.'">
													'.$cart_item_title.'
												</a>
											</p>
									...
									<div class="col-12 col-lg-6">
										<div class="form-floating input-group">
											...
											<div class="input-group-append">
												<input type="button" onclick="cart.update()" class="input-group-text fas" value="&#x2b;">
											</div>
										</div>
									</div>
									<div class="col-3">
