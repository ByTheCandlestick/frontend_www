	...
	<section>
		...
		<div class="row">
			...
			<div class="col-12 col-md-6 text-md-end">
				<div class="row">
					<div class="col-12 d-flex justify-content-end align-items-center p-0">
						<a href="/Oxygen/<?=(QS)?>/" class="btn btn-outline-primary m-1">
							<i class="fad fa-circle"></i>
						</a>
						<a href="javascript:website.page.update(<?=(QS)?>);" class="btn btn-outline-primary m-1">
							<i class="fa fa-save"></i>
						</a>
						<a href="javascript:website.page.delete(<?=(QS)?>);" class="btn btn-outline-danger m-1">
