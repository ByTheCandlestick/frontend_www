...
?><?
    ...
    $q = DB_Query($prnt = sprintf("SELECT * FROM `Product packaging` ORDER BY `ID` ASC LIMIT %s OFFSET %s", $config['Maximum list size'] OFFSET $offset));
...
<section>
	...
	<div class="row overflow-scroll">
		...
		<?
			...
			(($offset + $config['Maximum list size']) < $total_packagings)? $next_status = '': $next_status = ' disabled';
