            ...
            <div class="col-12 col-md-6 text-md-end">
                <div class="row">
                    <div class="col-12 d-flex justify-content-end align-items-center p-0">
                        <a href="javascript:website.style.create();" class="btn btn-outline-primary m-1">
...
<?
	} elseif(mysqli_num_rows($query = DB_Query(sprintf("SELECT * FROM `Website styles` WHERE `ID`=%s", QS))) > 0) {
...
?>
	<section>
		...
		<div class="row">
			...
			<div class="row">
				<div class="col-12 d-flex justify-content-end align-items-center p-0">
					<a href="javascript:website.style.delete(<?=(QS)?>);History.Go(-1);" class="btn btn-outline-danger m-1">
						<i class="fa fa-trash-alt"></i>
					</a>
					<a href="javascript:website.style.update(<?=(QS)?>);" class="btn btn-outline-primary m-1">
						<i class="fa fa-save"></i>
					</a>
				</div>
			</div>
		...
		<div class="row">
            ...
            <div class="col-12 col-md-6 col-lg-4" name="importance">
                <div class="form-floating mb-3">
                    <input type="number" class="form-control" id="floatingInput" placeholder="<? print(($style['Importance']=='')?'No base URL was set':'')?>" value="<? print(($style['Importance']=='')?'':$style['Importance'])?>">
                    <label for="floatingInput">Importance</label>
                </div>
            </div>
            <div class="col-12 col-md-6 col-lg-4" name="status">
