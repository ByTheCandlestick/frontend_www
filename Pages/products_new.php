		...
		<div class="col-12 col-md-6 col-lg-7">
			<div class="row">
				...
				<div class="col-12 col-lg-3" name="gross">
					<div class="form-floating mb-3 input-group">
						<span class="input-group-text" id="GBP">£</span>
						<input type="text" class="form-control" id="floatingInput" placeholder="" aria-describedby="GBP" value="">
				...
				<div class="col-12 col-lg-3" name="markup">
					<div class="form-floating mb-3 input-group">
						<span class="input-group-text" id="GBP">£</span>
						<input type="text" class="form-control" id="floatingInput" placeholder="" aria-describedby="percentage" value="">
