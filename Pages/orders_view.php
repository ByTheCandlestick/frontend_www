		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
					...
					<div class="row">
						<div class="col-6">
							<div class="form-floating mb-3 input-group">
								...
								<input type="text" class="form-control" id="floatingInput" value="0.00" step=".01" name="refundCurrValue" onChange="javascript:refundCheck();">
				...
				<div class="modal-footer">
					<button type="button" class="btn btn-primary" onClick="javascript:refundConfirm();">Refund</button>
