...
<section>
	...
	<div class="row" style="height:100%;">
		...
		<div class="col-12 col-md-6 col-lg-4 col-xl-3" style="overflow-x: hidden; overflow-y: scroll; height: calc(100% - 140px); border-right: solid 1px rgba(0,0,0,0.4); box-shadow: inset 7px 0px 9px -12px rgb(0 0 0)">
			
		</div>
		<div class="col-12 col-md-6 col-lg-4 col-xl-3" style="overflow-x: hidden; overflow-y: scroll; height: calc(100% - 140px); border-right: solid 1px rgba(0,0,0,0.4); box-shadow: inset 7px 0px 9px -12px rgb(0 0 0)">
			
		</div>
		<div class="col-12 col-md-6 col-lg-4 col-xl-3" style="overflow-x: hidden; overflow-y: scroll; height: calc(100% - 140px); box-shadow: inset 7px 0px 9px -12px rgb(0 0 0)">
