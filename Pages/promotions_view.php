		...
		<div class="row">
			...
			<div class="row">
				<div class="col-12 d-block d-md-flex justify-content-end align-items-center p-0">
					<a href="/Promotions/Edit/<?=QS?>" class="btn btn-outline-primary m-1">
		...
		<div class="row">
			<div class="col-12 col-md-6 col-lg-2" name="name">
				<div class="form-floating mb-3">
					<input type="text" class="form-control" id="floatingInput" placeholder="" value="<?= $promotion['Name']?>" disabled>
					<label for="floatingInput">Name</label>
				</div>
			</div>
			<div class="col-12 col-md-6 col-lg-2" name="percentage">
				<div class="form-floating mb-3">
					<input type="number" class="form-control" id="floatingInput" placeholder="" value="<?= $promotion['Percentage discount']?>" disabled>
					<label for="floatingInput">Percentage</label>
				</div>
			</div>
			<div class="col-12 col-md-6 col-lg-2" name="start">
				<div class="form-floating mb-3">
					<input type="date" class="form-control" id="floatingInput" placeholder="" value="<?= $promotion['Scheduled start']?>" disabled>
					<label for="floatingInput">Start</label>
				</div>
			</div>
			<div class="col-12 col-md-6 col-lg-2" name="end">
				<div class="form-floating mb-3">
					<input type="date" class="form-control" id="floatingInput" placeholder="" value="<?= $promotion['Scheduled end']?>" disabled>
					<label for="floatingInput">End</label>
				</div>
			</div>
			<div class="col-12 col-md-6 col-lg-2" name="voucher">
				<div class="form-floating mb-3">
					<input type="text" class="form-control" id="floatingInput" placeholder="" value="<?= $promotion['Voucher']?>" disabled>
			...
			<div class="col-12 col-md-3 col-lg-2" name="misc">
				<div class="form-floating mb-3">
					<div class="form-check form-switch">
						...
						<input class="form-check-input" type="checkbox" value="1" id="flexCheckDisabled" name="active" <?=($checked)?> disabled>
						<label class="form-check-label" for="flexCheckDisabled"> Active? </label>
					</div>
					<div class="form-check form-switch">
						<? ($promotion['Type']==1)?$checked="checked":$checked=""; ?>
						<input class="form-check-input" type="checkbox" value="1" id="flexCheckDisabled" name="voucher" <?=($checked)?> disabled>
			...
			<div class="col-12 col-md-6 col-lg-4" name="description">
				<div class="form-floating mb-3">
					<textarea class="form-control" id="floatingInput" style="height: 132px;" placeholder="" disabled><?= $promotion['Description']?></textarea>
			...
			<div class="col-12 col-md-6 col-lg-2" name="collections">
				...
				<?
					...
					while($row = mysqli_fetch_array($query)) {
						...
						print('
							<div class="form-check">
								<input class="form-check-input" type="checkbox" value="' . $row['ID'] . '" id="CollectionCheckboxes-'.$row['ID'].'" '.$checked.' disabled>
